...
class ewriter():
    def __init__(self):
        self.model =ChatOpenAI(openai_api_base="https://openrouter.ai/api/v1",api_key=openai_key,model = "openai/gpt-3.5-turbo",temperature=0)
...
class writer_gui( ):
    ...
    def update_thread_pd(self,):
        ...
        return gr.Dropdown(label="choose thread", choices=self.thread, value=self.thread_id,interactive=True)
